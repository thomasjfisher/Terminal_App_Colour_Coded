...
module ColourCodedGame
  ...
  def run_game
    ...
    colors = %i[black light_black red green yellow blue magenta light_magenta cyan light_cyan]
    counter = 0
    wrong_answer = 0
    guess_count = 1
    ...
    while counter < 5
      ...
      print word + ' '
      tom_sleep 1
      clear_terminal if DEBUG.nil?

      puts 'Please enter your guess!'
      puts
      user_input = gets.strip.downcase
      puts
      user_input = word if DEBUG
      if word == user_input
        grats
        tom_sleep 3
        clear_terminal
      ...
      next unless wrong_answer == 3 || counter == correct_guesses_needed
